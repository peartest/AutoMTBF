...
var Android = function () {
  console.log("[ZHAOJIAJUN]New a android instance");
  this.init();
};
...
Android.prototype.initQueue = function () {
  console.log("[ZHAOJIAJUN]Init Queue");
  this.queue = async.queue(function (task, cb) {
    ...
    if (this.adb && !this.shuttingDown) {
      console.log("[ZHAOJIAJUN]Ready to send action!!!!");
      console.log("[ZHAOJIAJUN]" + action);
