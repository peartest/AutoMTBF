...
UiAutomator.prototype.sendAction = function (action, params, cb) {
  console.log("[ZHAOJIAJUN]SEND ACTION");
  if (typeof params === "function") {
    cb = params;
    params = {};
  }
  var extra = {action: action, params: params};
  if(action === "startLogcat"){
    console.log("[ZHAOJIAJUN]Start logcat,send command")
    this.sendCommand('logstart',extra,cb)
  }
  else if(action === "endLogcat"){
    console.log("[ZHAOJIAJUN]End logcat,send command")
    this.sendCommand('logend',extra,cb)
  }
  else{
...
UiAutomator.prototype.sendCommand = function (type, extra, cb) {
  if (this.cmdCb !== null) {
    ...
    console.log("[ZHAOJIAJUN]Send command");
    this.resendLastCommand = function () {
      this.sendCommand(type, extra, cb);
    }.bind(this);
