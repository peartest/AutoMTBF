...
module.exports = function (appium) {
  ...
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/contentdesc', controller.elementContentDesc);
  ...
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/checked', controller.elementChecked);
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/checkable', controller.elementCheckable);
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/clickable', controller.elementClickable);
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/longclickable', controller.elementLongclickable);
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/focused', controller.elementFocused);
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/focusable', controller.elementFocusable);
  rest.get('/wd/hub/session/:sessionId?/element/:elementId?/scrollable', controller.elementScrollable);
  ...
  rest.post('/wd/hub/session/:sessionId?/appium/device/lock_android_device', controller.lockAndroidDevice);
  rest.post('/wd/hub/session/:sessionId?/appium/device/wake_up_android_device', controller.wakeupAndroidDevices);
  rest.post('/wd/hub/session/:sessionId?/appium/device/is_android_screen_on', controller.isAndroidScreenOn);
  rest.post('/wd/hub/session/:sessionId?/appium/device/package', controller.getPackage);
  rest.post('/wd/hub/session/:sessionId?/appium/device/package', controller.getPackage);
  rest.post('/wd/hub/session/:sessionId?/appium/device/log_start', controller.startLog);
  rest.post('/wd/hub/session/:sessionId?/appium/device/log_end', controller.endLog);
  rest.post('/wd/hub/session/:sessionId?/appium/device/clear_android_text', controller.clearAndroidText);
  rest.post('/wd/hub/session/:sessionId?/appium/device/screen_capture',controller.screenCapture);
  rest.post('/wd/hub/session/:sessionId?/appium/device/android_monkey_test',controller.androidMonkey);
  rest.post('/wd/hub/session/:sessionId?/appium/device/pull_file_to_local',controller.pullFilesToLocal);
  rest.post('/wd/hub/session/:sessionId?/appium/device/wait_element_exist',controller.waitElementExist);
  rest.post('/wd/hub/session/:sessionId?/appium/device/scroll_element_to_text',controller.scrollElementToText);
  rest.post('/wd/hub/session/:sessionId?/appium/device/click_element_with_description',controller.clickElementWithDescription);
  rest.post('/wd/hub/session/:sessionId?/appium/device/click_element_with_id',controller.clickElementWithId);
  rest.post('/wd/hub/session/:sessionId?/appium/device/captureByUiautomator',controller.captureScreenshotByUiautomator);
  ...
  rest.post('/wd/hub/session/:sessionId?/appium/device/forcestop', controller.forceStopApp);
