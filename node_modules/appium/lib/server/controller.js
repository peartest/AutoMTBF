...
exports.androidMonkey = function(req,res){
  //req.device.monkey(req.body.package,getResponseHandler(req,res));
  req.device.monkey(req.body.package,function(error,response){
    if (error !== null) {
...
exports.pullFilesToLocal = function(req,res){
  var devicePath = req.body.devicePath;
  var localPath = req.body.localPath;
  req.device.pullFilesToLocal(devicePath,localPath,function(error,response){
    if(error !== null){
      respondError(req, res, response);
    }
    else{
...
exports.screenCapture = function(req,res){
  var path = req.body.screenshotPath;
  var name = req.body.screenshotName;
  req.device.screenCapture(path,name,function(error,response){
    if (error !== null) {
      respondError(req, res, response);
    } else {
      respondSuccess(req, res, response);
...
exports.lockAndroidDevice = function (req,res){
  req.device.lockAndroidDevice(getResponseHandler(req,res));
}

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.wakeupAndroidDevices = function (req,res){
  req.device.wakeUpDevice(getResponseHandler(req,res));
};

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.isAndroidScreenOn = function(req,res){
  req.device.isScreenOn(getResponseHandler(req,res));
};

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.getPackage = function(req,res){
  req.device.getCurrentPackage(getResponseHandler(req,res))
};

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.startLog = function(req,res){
  var wholeTestFolderName = req.body.wholeTestFolderName;
  var roundFolderName = req.body.roundFolderName;
  var udid = req.body.udid;
  var time = req.body.startTime;
  var currentloop = req.body.loop;
  var scriptName = req.body.scriptName;
  var logStorePath = req.body.logStorePath;
  req.device.startLogcat(wholeTestFolderName,roundFolderName,udid,time,currentloop,scriptName,logStorePath,getResponseHandler(req,res))
};

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.endLog = function(req,res){
  req.device.endLogcat(getResponseHandler(req,res))
};

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.forceStopApp = function(req,res){
  var packageName = req.body.package;
  req.device.forceStopApp(packageName,getResponseHandler(req,res));
};

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.waitElementExist = function(req,res){
  var resourceid = req.body.resourceid;
  var timeout = req.body.timeout;
  req.device.waitElementExist(resourceid,timeout,getResponseHandler(req,res))
}

// author:ZhaoJiajun,mail:Zhaojj0506@thundersoft.com
exports.scrollElementToText = function(req,res){
  var resourceid = req.body.resourceid;
  var text = req.body.text;
  var instance = req.body.instance;
  req.device.scrollElementToText(resourceid,text,instance,getResponseHandler(req,res));
}

exports.clickElementWithDescription = function(req,res){
  var description = req.body.description;
  var type = req.body.type;
  req.device.clickElementWithDescription(description,type,getResponseHandler(req,res));
}

exports.clickElementWithId = function(req,res){
  var id = req.body.id;
  req.device.clickElementWithId(id,getResponseHandler(req,res));
}

exports.captureScreenshotByUiautomator = function(req,res){
  var storePath = req.body.storePath;
  var storeName = req.body.storeName;
  req.device.captureScreenshotByUiautomator(storePath,storeName,getResponseHandler(req,res))
}

exports.clearAndroidText = function(req,res){
  var id = req.body.resourceid;
  req.device.clearText(id,getResponseHandler(req, res));
};
...
exports.deleteSession = function (req, res) {
  console.log("[ZHAOJIAJUN]Script quit.");
...
exports.findElement = function (req, res) {
  ...
  if (checkMissingParams(req, res, {strategy: strategy, selector: selector}, true)) {
    req.device.findElement(strategy, selector,type, getResponseHandler(req, res));
  }
};
...
exports.performTouch = function (req, res) {
  ...
  if (gestures && !Array.isArray(gestures)) {
    console.log("[ZHAOJIAJUN]Enter here for actions")
  ...
  if (gestures.length === 4 &&
      ...
      console.log("[ZHAOJIAJUN]Enter here for actions type")
...
exports.elementContentDesc = function(req,res){
  var elementId = req.params.elementId;
  req.device.getContentDesc(elementId,getResponseHandler(req, res));
}
...
exports.elementChecked = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementChecked(elementId,getResponseHandler(req,res))
}

exports.elementCheckable = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementCheckable(elementId,getResponseHandler(req,res));
}

exports.elementClickable = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementClickable(elementId,getResponseHandler(req,res))
}

exports.elementLongclickable = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementLongclickable(elementId,getResponseHandler(req,res))
}

exports.elementFocused = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementFocused(elementId,getResponseHandler(req,res))
}

exports.elementFocusable = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementFocusable(elementId,getResponseHandler(req,res))
}

exports.elementScrollable = function(req,res){
  var elementId = req.params.elementId;
  req.device.elementScrollable(elementId,getResponseHandler(req,res))
}
