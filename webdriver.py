...
class WebDriver(webdriver.Remote):
    def __init__(self, command_executor='http://127.0.0.1:4444/wd/hub',
        ...
        if self.command_executor is not None:
            print('command_executor is not None,start to add user define command')
            self._addCommands()
    ...
    __author__ = 'zhaojj0506@thundersoft.com'
    def find_element_by_partial_text(self,text):
        return self.find_element(by=By.PARTIAL_TEXT,value=text)

    __author__ = 'zhaojj0506@thundersoft.com'
    def find_elements_by_partial_text(self,text):
        return self.find_elements(by=By.PARTIAL_TEXT,value=text);
    ...
    __author__ = 'zhaojj0506@thundersoft.com'
    def drag_and_drop_by_point(self,startX,startY,endX,endY):
        """
        Drag from one point to point
        :param startX:
        :param startY:
        :param endX:
        :param endY:
    ...
    __author__ = 'zhaojj0506@thundersoft.com'
    def wait_element_exist(self,resourceId,timeout):
        data = {
            'resourceid':resourceId,
            'timeout':timeout
        }
        return self.execute(Command.WAIT_ELEMENT_EXIST,data)['value']

    __author__ = 'zhaojj0506@thundersoft.com'
    def scroll_element_to_text(self,resId,text,instance=0):
        data = {
            'resourceid':resId,
            'text':text,
            'instance':instance
        }
        return self.execute(Command.SCROLL_ELEMENT_TO_TEXT,data)['value']

    __author__ = 'zhaojj0506@thundersoft.com'
    def clickElementWithDescription(self,description,type):
        data = {
            'description':description,
            'type':type
        }
        self.execute(Command.CLICK_BY_DESCRIPTION,data)

    __author__ = 'zhaojj0506@thundersoft.com'
    def clickElementWithId(self,id):
        data = {
            'id':id
        }
        self.execute(Command.CLICK_BY_ID,data)
    ...
    __author__ = 'zhaojj0506@thundersoft.com'
    def android_monkey_test(self,package):
        """
        start monkey test
        :return:
        """
        ...
        self.execute(Command.MONKEY,data);
        return self;

    __author__ = 'zhaojj0506@thundersoft.com'
    def screen_capture(self,screenshot_path,screenshot_name):
        """
        ...
        return self.execute(Command.SCREEN_CAPTURE,data);

    __author__ = 'zhaojj0506@thundersoft.com';
    def wake_up_android_device(self):
        """ wake up device
        :return:
        """
        self.execute(Command.WAKE_UP_ANDROID_DEVICE);
        return self;

    __author__ = 'zhaojj0506@thundersoft.com';
    def lock_android_device(self):
        """ lock device ,make device screen put out
        :return:
        """
        self.execute(Command.LOCK_ANDROID_DEVICE)
        return self;

    __author__ = 'zhaojj0506@thundersoft.com';
    def clear_text(self,resourceid):
        """
        clear text
        :return:
        """
        ...
        self.execute(Command.CLEAR_ANDROID_TEXT,data);
        return self;

    __author__ = 'zhaojj0506@thundersoft.com'
    @property
    def is_android_screen_on(self):
        """ check if the android device screen on
        :return:
        """
        return self.execute(Command.IS_SCREEN_ON)['value'];
    ...
    def get_current_package(self):
        ...
        :return:
        """
        return self.execute(Command.PACKAGE)['value'];
    ...
    def force_stop_app(self,package):
        ...
        return self.execute(Command.FORCESTOP,data);

    def pull_file_to_local(self,devicePath,localPath):
        """
        pull the file or folder on device to local
        :param devicePath:
        :param localPath:
        :return:
        """
        ...
        return self.execute(Command.PULL_FILES,data)

    __author__ = 'zhaojj0506@thundersoft.com'
    def log_start(self,logStorePath="",wholeTestFolder=None,roundFolder=None,deviceID=None,startTime=None,currentLoop=None,scriptName=None):
        data = {
            'wholeTestFolderName':wholeTestFolder,
            'roundFolderName':roundFolder,
            'udid':deviceID,
            'startTime':startTime,
            'loop':currentLoop,
        ...
        return self.execute(Command.LOG_START,data)['value']

    __author__ = 'zhaojj0506@thundersoft.com'
    def log_end(self):
        return self.execute(Command.LOG_END)

    __author__ = 'zhaojj0506@thundersoft.com'
    def cap_screen_by_uiautomator(self,storePath,storeName):
        data = {
            'storePath':storePath,
            'storeName':storeName
        }
        return self.execute(Command.CAPTURE_UIAUTOMATOR,data)
    ...
    def _addCommands(self):
        ...
        self.command_executor._commands[Command.LOCK_ANDROID_DEVICE] = \
            ('POST', '/session/$sessionId/appium/device/lock_android_device')
        self.command_executor._commands[Command.WAKE_UP_ANDROID_DEVICE] = \
            ('POST', '/session/$sessionId/appium/device/wake_up_android_device')
        self.command_executor._commands[Command.CLEAR_ANDROID_TEXT] = \
            ('POST', '/session/$sessionId/appium/device/clear_android_text')
        self.command_executor._commands[Command.IS_SCREEN_ON] = \
            ('POST', '/session/$sessionId/appium/device/is_android_screen_on')
        self.command_executor._commands[Command.PACKAGE] = \
            ('POST', '/session/$sessionId/appium/device/package')
        self.command_executor._commands[Command.FORCESTOP] = \
            ('POST', '/session/$sessionId/appium/device/forcestop')
        self.command_executor._commands[Command.LOG_START] = \
            ('POST', '/session/$sessionId/appium/device/log_start')
        self.command_executor._commands[Command.LOG_END] = \
            ('POST', '/session/$sessionId/appium/device/log_end')
        self.command_executor._commands[Command.CAPTURE_UIAUTOMATOR] = \
            ('POST', '/session/$sessionId/appium/device/captureByUiautomator')
        self.command_executor._commands[Command.SCREEN_CAPTURE] = \
            ('POST', '/session/$sessionId/appium/device/screen_capture')
        self.command_executor._commands[Command.MONKEY] = \
            ('POST', '/session/$sessionId/appium/device/android_monkey_test')
        self.command_executor._commands[Command.WAIT_ELEMENT_EXIST] = \
            ('POST', '/session/$sessionId/appium/device/wait_element_exist')
        self.command_executor._commands[Command.SCROLL_ELEMENT_TO_TEXT] = \
            ('POST', '/session/$sessionId/appium/device/scroll_element_to_text')
        self.command_executor._commands[Command.CLICK_BY_DESCRIPTION] = \
            ('POST', '/session/$sessionId/appium/device/click_element_with_description')
        self.command_executor._commands[Command.CLICK_BY_ID] = \
            ('POST', '/session/$sessionId/appium/device/click_element_with_id')
        self.command_executor._commands[Command.PULL_FILES] = \
            ('POST', '/session/$sessionId/appium/device/pull_file_to_local')
